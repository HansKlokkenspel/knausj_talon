...
formatters_dict = {
    ...
    "PRIVATE_READONLY_CAMEL_CASE": (NOSEP, first_vs_rest(lambda w: "_" + w, lambda w: w.capitalize())),
    "INTERFACE_CASE": (NOSEP, first_vs_rest(lambda w: "I" + w.capitalize(), lambda w: w.capitalize())),
...
formatters_words = {
    ...
    "privy": formatters_dict["PRIVATE_READONLY_CAMEL_CASE"],
    "interfacing": formatters_dict["INTERFACE_CASE"],
    "hammer": formatters_dict["PUBLIC_CAMEL_CASE"],
    "kebab": formatters_dict["DASH_SEPARATED"],
    "packed": formatters_dict["DOUBLE_COLON_SEPARATED"],
    "allcaps": formatters_dict["ALL_CAPS"],
    "alldown": formatters_dict["ALL_LOWERCASE"],
    "stringy": formatters_dict["SINGLE_QUOTED_STRING"],
